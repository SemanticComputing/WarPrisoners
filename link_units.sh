...
GET_CANDIDATES="$PROG data/new/prisoners_plain.ttl data/new/unit_candidates.ttl http://candidates/unit http://demo.seco.tkk.fi/arpa/warsa_actor_units --prop http://ldf.fi/schema/warsa/prisoners/unit -n -c -r 3 -w 3"
...
CAT_ARGS="data/new/prisoners_plain.ttl data/new/periods.ttl data/new/unit_candidates_combined.ttl"
