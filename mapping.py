...
PRISONER_MAPPING = {
    ...
    '1) paluukuulustelu-pöytäkirja; 2) kjan lausunto; 3) ilmoitus jääneistä sotavangeista 4) kuulustelija 5) h-mappi 6) oma kertomus 7) väkivalta kuulusteluissa NL:ssa':
        {'uri': SCHEMA_NS.minutes, 'value_separator': '/',
         'name_en': 'Returning interrogation minutes',
         'name_fi': 'Paluukuulustelu-pöytäkirja'},
    ...
    'muistelmat, lehtijutut, tietokirjat':
